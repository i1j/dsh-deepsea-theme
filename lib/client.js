...
function createParamsPanel(env) {
	const panel = el("div", "position:fixed;left:8px;bottom:8px;width:268px;z-index:10000;box-sizing:border-box;background:rgb(28,40,60);border:1px solid rgba(94,192,226,.35);border-radius:10px;padding:10px 12px 12px;color:rgb(198,214,234);font-size:12px;line-height:1.5;box-shadow:0 10px 28px rgba(0,0,0,.5);display:none;max-height:calc(100vh - 24px);overflow-y:auto;");
	...
	const closeBtn = el("button", "border:0;background:none;cursor:pointer;color:rgb(170,196,222);font-size:14px;padding:2px 4px;", "✕");
	...
	for (const spec of SPECS) {
		if (isDivider(spec)) {
			panel.appendChild(el("div", "margin:6px 0 7px;padding-top:7px;border-top:1px solid rgba(94,192,226,.24);color:rgb(130,214,242);font-size:11px;letter-spacing:.05em;", spec.divider));
			continue;
		}
	...
	const resetBtn = el("button", "width:100%;margin-top:4px;padding:5px 0;border:1px solid rgba(94,192,226,.4);border-radius:6px;background:rgba(63,200,232,.16);color:rgb(140,220,246);font-size:11px;cursor:pointer;", "恢复默认");
...
function customSlenderJellyfishSvg() {
	return "<svg class=\"dsh-jelly\" width=\"27\" height=\"44\" viewBox=\"0 0 24 40\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.3\" stroke-linecap=\"round\" xmlns=\"http://www.w3.org/2000/svg\"><path class=\"jelly-bell\" d=\"M5 12C5 6.2 8.1 2.6 12 2.6s7 3.6 7 9.4\"/><path class=\"jelly-bell\" d=\"M5 12c0 .8.6 1.4 1.4 1.4h11.2c.8 0 1.4-.6 1.4-1.4\"/><path class=\"jelly-tentacle-l\" d=\"M6.5 14.6C6.5 21 6.8 27 7.6 33c.25 1.6.4 3.2.5 4.8\"/><path class=\"jelly-tentacle-l2\" d=\"M10 14.6C10 21 10.3 27 11.1 33c.25 1.6.4 3.2.5 4.8\"/><path class=\"jelly-tentacle-r2\" d=\"M14 14.6C14 21 13.7 27 12.9 33c-.25 1.6-.4 3.2-.5 4.8\"/><path class=\"jelly-tentacle-r\" d=\"M17.5 14.6C17.5 21 17.2 27 16.4 33c-.25 1.6-.4 3.2-.5 4.8\"/></svg>";
}
...
function createJellyfishButton(title) {
	...
	btn.style.cssText = "position:fixed;z-index:9999;width:" + BTN_SIZE + "px;height:40px;border-radius:50%;display:flex;align-items:center;justify-content:center;line-height:1;padding:0;cursor:pointer;border:0;background:transparent;opacity:.6;transition:opacity .15s;display:none;color:rgb(63,200,232);";
