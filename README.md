...
从 deepseek-harness fork 的 `conversation` 补丁（2026-08-13）中独立出来的纯客户端 CSS 插件，
零依赖、零侵入——不改 dist、不碰组件逻辑，一处生效全站。

![深海 · 深色模式](assets/theme-dark.png)
![浅海 · 亮色模式](assets/theme-light.png)
